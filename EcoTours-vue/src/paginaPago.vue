...
export default {
  ...
  //funcion que multiplica el precio por la cantidad de personas
  methods: {
    seleccionarVuelo(vuelo) {
      ...
      // Marca el vuelo seleccionado y copia sus datos al formulario.
      // y muestra la info del paquete.
    enviarFormulario() {
      alert(`✅ Reserva confirmada para ${this.form.nombre} hacia ${this.form.destino}.
      Total pagado: USD ${this.totalPagar}`);
      // se muestra una alerta para simular la confirmación.
        },
      },
    };
</script>
...
<template>
  <div class="pagina-viajes">
    ...
    <!-- Lista de vuelos/ofertas -->
    <section class="ofertas">
      <h2>Mejores ofertas desde Venezuela</h2>

      <div class="grid-ofertas">
        <!-- Recorre 'vuelos' y genera una tarjeta por cada elemento -->
        <div
        ...
        >
          ...
          <div class="info">
            ...
            <!-- BOTÓN: selecciona el vuelo y muestra el formulario -->
  ...
  <!-- 'totalPagar' es una propiedad computed que recalcula cuando cambia precio o personas -->
